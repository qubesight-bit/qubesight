...
const LogoCube = ({ className = "" }: LogoCubeProps) => {
  return (
    ...
    >
      ...
      <motion.span
        className="logo-text-mobile font-display font-bold text-lg sm:text-xl tracking-tight text-white transition-colors duration-300 group-hover:text-cyan-400"
