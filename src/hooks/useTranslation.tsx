...
export const translations: Translations = {
  ...
  'pricing.basic.name': { es: 'QubeSight Starter', en: 'QubeSight Starter' },
  'pricing.basic.desc': { es: 'Para empezar a automatizar conversaciones.', en: 'To start automating conversations.' },
  'pricing.basic.f1': { es: '1,000 mensajes incluidos', en: '1,000 messages included' },
  'pricing.basic.f2': { es: 'Automatización básica', en: 'Basic automation' },
  'pricing.basic.f3': { es: 'Captura de leads', en: 'Lead capture' },
  'pricing.basic.f4': { es: 'Exceso a $0.035 por mensaje', en: 'Overage at $0.035 per message' },
  'pricing.growth.name': { es: 'QubeSight Growth', en: 'QubeSight Growth' },
  'pricing.growth.desc': { es: 'El plan core para escalar con IA avanzada.', en: 'The core plan to scale with advanced AI.' },
  'pricing.growth.f1': { es: '3,000 mensajes incluidos', en: '3,000 messages included' },
  'pricing.growth.f2': { es: 'IA avanzada', en: 'Advanced AI' },
  'pricing.growth.f3': { es: 'Multi-canal (WhatsApp + Web + IG)', en: 'Multi-channel (WhatsApp + Web + IG)' },
  'pricing.growth.f4': { es: 'Analytics y reportes', en: 'Analytics and reports' },
  'pricing.growth.f5': { es: 'Exceso a $0.03 por mensaje', en: 'Overage at $0.03 per message' },
  'pricing.propia.name': { es: 'QubeSight Scale', en: 'QubeSight Scale' },
  'pricing.propia.desc': { es: 'Para operaciones serias con automatizaciones complejas.', en: 'For serious operations with complex automations.' },
  'pricing.propia.setup': { es: 'Setup', en: 'Setup' },
  'pricing.propia.f1': { es: '7,000 mensajes incluidos', en: '7,000 messages included' },
  'pricing.propia.f2': { es: 'Automatizaciones complejas', en: 'Complex automations' },
  'pricing.propia.f3': { es: 'Optimización continua', en: 'Continuous optimization' },
  'pricing.propia.f4': { es: 'Soporte prioritario real', en: 'Real priority support' },
  'pricing.propia.f5': { es: 'Exceso a $0.025 por mensaje', en: 'Overage at $0.025 per message' },
  ...
  'pricing.voice.bronze.f1': { es: 'Agenda automática de citas', en: 'Automatic appointment booking' },
  'pricing.voice.bronze.f2': { es: 'Respuesta de preguntas frecuentes (FAQ)', en: 'FAQ answering' },
  'pricing.voice.bronze.f3': { es: '1 idioma de atención', en: '1 service language' },
  'pricing.voice.bronze.f4': { es: 'Resumen automático por email de cada llamada', en: 'Automatic email summary per call' },
  'pricing.voice.bronze.f5': { es: 'Atención 24/7', en: '24/7 service' },
  ...
  'pricing.voice.silver.f3': { es: 'Envío de cotizaciones en tiempo real por SMS', en: 'Real-time quotes via SMS' },
  'pricing.voice.silver.f4': { es: 'Agenda inteligente (validación de disponibilidad)', en: 'Smart scheduling (availability validation)' },
  'pricing.voice.silver.f5': { es: 'Llamadas simultáneas', en: 'Simultaneous calls' },
  ...
  'pricing.voice.gold.f2': { es: 'Multilenguaje (hasta 4 idiomas)', en: 'Multilingual (up to 4 languages)' },
  'pricing.voice.gold.f3': { es: 'Pagos y cobros por voz durante la llamada', en: 'Voice payments and checkout during the call' },
  'pricing.voice.gold.f4': { es: 'Automatización de procesos (pedidos, CRM, etc.)', en: 'Process automation (orders, CRM, etc.)' },
  'pricing.voice.gold.f5': { es: 'Integraciones avanzadas', en: 'Advanced integrations' },
