...
export const translations: Translations = {
  ...
  'nav.propia': { es: 'Inmobiliarias', en: 'Real Estate' },
  'nav.qubeops': { es: 'Operaciones', en: 'Operations' },
  ...
  'pricing.starter.f1': { es: 'Hasta 800 mensajes/mes (texto y audio)', en: 'Up to 800 messages/mo (text and audio)' },
  'pricing.starter.f2': { es: 'Entiende notas de voz automáticamente', en: 'Auto-understands voice notes' },
  'pricing.starter.f3': { es: 'Excedente: $0.03/mensaje', en: 'Overage: $0.03/message' },
  'pricing.basic.name': { es: 'Bronce', en: 'Bronze' },
  'pricing.basic.desc': { es: 'Atiende 24/7 con IA conversacional avanzada.', en: 'Serve 24/7 with advanced conversational AI.' },
  'pricing.basic.f1': { es: 'Hasta 2,500 mensajes', en: 'Up to 2,500 messages' },
  'pricing.basic.f2': { es: 'IA conversacional avanzada', en: 'Advanced conversational AI' },
  'pricing.basic.f3': { es: 'Agenda en Google Calendar', en: 'Google Calendar booking' },
  'pricing.basic.f4': { es: 'Cotiza y envía links de pago', en: 'Quotes and payment links' },
  'pricing.basic.f5': { es: '1 idioma', en: '1 language' },
  'pricing.growth.name': { es: 'Plata', en: 'Silver' },
  'pricing.growth.desc': { es: 'Todo Bronce + memoria, multiidioma y handoff.', en: 'Everything in Bronze + memory, multilingual and handoff.' },
  'pricing.growth.f1': { es: 'Hasta 6,000 mensajes', en: 'Up to 6,000 messages' },
  'pricing.growth.f2': { es: 'Memoria de conversación', en: 'Conversation memory' },
  'pricing.growth.f3': { es: 'Multiidioma', en: 'Multilingual' },
  'pricing.growth.f4': { es: 'Handoff a humano', en: 'Handoff to human' },
  'pricing.growth.f5': { es: 'Notificaciones automáticas', en: 'Automatic notifications' },
  'pricing.propia.name': { es: 'Oro', en: 'Gold' },
  'pricing.propia.desc': { es: 'Todo Plata + CRM, catálogo y omnicanal.', en: 'Everything in Silver + CRM, catalog and omnichannel.' },
  'pricing.propia.setup': { es: 'Setup', en: 'Setup' },
  'pricing.propia.f1': { es: 'Hasta 15,000 mensajes', en: 'Up to 15,000 messages' },
  'pricing.propia.f2': { es: 'Sincronización CRM', en: 'CRM synchronization' },
  'pricing.propia.f3': { es: 'Catálogo interactivo en WhatsApp', en: 'Interactive catalog on WhatsApp' },
  'pricing.propia.f4': { es: 'Omnicanal (WA + IG + Web)', en: 'Omnichannel (WA + IG + Web)' },
  'pricing.propia.f5': { es: 'Todo lo del plan Plata', en: 'Everything in Silver plan' },
